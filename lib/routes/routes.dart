...
import 'package:apicode/pages/demo/demo.dart';
import 'package:apicode/pages/home/home.dart';
...
class Routes {
  ...
  static const String main = "/second";
...
class RouterGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.main:
        return _GeneratePageRoute(
            widget:  const MyAppmain(), routeName: settings.name);
      default:
        return _GeneratePageRoute(
            widget: Home(), routeName: settings.name);
    }
